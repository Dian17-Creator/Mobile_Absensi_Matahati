        ...
        fusedLocationClient.lastLocation.addOnSuccessListener { loc ->
            ...
            coroutineScope.launch(Dispatchers.IO) {
                try {
                    ...
                    val url = "https://checkin.karyatra.cloud/reverse_geocode.php?lat=$lat&lon=$lng"
            ...
            Card(
                ...
                Column(
                                ...
                                ExposedDropdownMenu(
                                    ...
                                    typeList.forEach {
                                        DropdownMenuItem(
                                            ...
                                            onClick = {
                                                reqType.value =
                                                    if (it == "Reguler") "reguler" else "request"
                                                expandedType = false
                                            }
                                        )
                                    }
                    ...
                    Button(
                        onClick = {
                            coroutineScope.launch {
                                ...
                                if (result.success || result.message.contains("offline", true)) {
                                    withContext(Dispatchers.Main) {
                                        Toast.makeText(activity, "Data Berhasil Dikirim Ke Server", Toast.LENGTH_LONG).show()
                        ...
                        Text(if (isLoading.value) "Loading..." else "Submit")
                    }
                }
            }
...
suspend fun uploadRequest(
    ...
    try {
        ...
        val request = Request.Builder()
            ...
            .url("https://checkin.karyatra.cloud/user_request_mobile_2.php")
